...
def get_coords_from_cube(cubename: str, return_meso: bool = False, ignore_warning = False, train=True):
    """
    ...
    if train:
        ...
        _, cubetile, _, _,hr_x_min, hr_x_max, hr_y_min, hr_y_max, meso_x_min, meso_x_max, meso_y_min, meso_y_max = os.path.splitext(cubename)[0].split("_")
